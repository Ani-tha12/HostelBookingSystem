...
public class HostelController {
	...
	@PostMapping
	public ResponseEntity<ApiResponse<HostelResponse>> addHostel(@Valid @RequestBody HostelRequest request) {
	...
	@GetMapping("/search")
	public ResponseEntity<ApiResponse<List<HostelResponse>>> searchHostelsByCity(@RequestParam String city) {
	...
	public ResponseEntity<ApiResponse<List<HostelResponse>>> getHostelsByOwner(@PathVariable Long ownerId) {
	...
	@PutMapping("/{hostelId}")
	public ResponseEntity<ApiResponse<HostelResponse>> updateHostel(@PathVariable Long hostelId,
	...
	public ResponseEntity<ApiResponse<HostelResponse>> assignFacilities(@PathVariable Long hostelId,
			@RequestBody List<Long> facilityIds) {
		HostelResponse response = hostelService.assignFacilities(hostelId, facilityIds);
		return ResponseEntity.ok(ApiResponse.success("Facilities assigned successfully", response));
	}

	@DeleteMapping("/{hostelId}/facilities/{facilityId}")
	public ResponseEntity<ApiResponse<HostelResponse>> removeFacility(@PathVariable Long hostelId,
			@PathVariable Long facilityId) {
		HostelResponse response = hostelService.removeFacility(hostelId, facilityId);
		return ResponseEntity.ok(ApiResponse.success("Facility removed successfully", response));
	}
	...
	public ResponseEntity<ApiResponse<List<HostelResponse>>> getPendingHostels() {
		...
		return ResponseEntity.ok(ApiResponse.success("Pending hostels retrieved successfully", hostels));
	}
	...
	public ResponseEntity<ApiResponse<String>> rejectHostel(@PathVariable Long hostelId, @RequestParam String reason) {
