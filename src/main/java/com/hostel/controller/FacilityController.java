...
public class FacilityController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponse<FacilityResponse>> addFacility(
    ...
    public ResponseEntity<ApiResponse<FacilityResponse>> updateFacility(
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Facility updated successfully", response)
        );
    }
    ...
    public ResponseEntity<ApiResponse<String>> deleteFacility(@PathVariable Long facilityId) {
        ...
        return ResponseEntity.ok(
            ApiResponse.success("Facility deleted successfully", null)
        );
    }
}
